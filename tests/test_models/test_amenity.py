#!/usr/bin/python3
"""
Unit tests for the Amenity class, ensuring compliance with project requirements.

These tests cover:
    - Presence of docstrings for modules, classes, and functions.
    - File execution permissions.
    - Correct class inheritance and attribute existence.
    - Object initialization and ID uniqueness.
    - String representation format.
    - Updating of `updated_at` attribute upon saving.
    - Output of `to_dict` method, including class name and stringified dates.
"""
